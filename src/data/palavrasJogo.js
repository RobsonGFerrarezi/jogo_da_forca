// src/data/palavrasJogo.js

/**
 * Este arquivo exporta um único objeto JavaScript chamado `palavrasParaForca`.
 * Este objeto funciona como o "banco de dados" de palavras do jogo.
 * * A estrutura é a seguinte:
 * - Cada chave do objeto (ex: 'Frutas', 'Animais') representa uma categoria.
 * - O valor de cada chave é um array de strings, onde cada string é uma
 * palavra ou frase para ser adivinhada no jogo.
 */
...
// Torna o objeto `palavrasParaForca` disponível para ser importado em outros arquivos.
